...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	  ...
	  <section class="hero-wrap js-fullheight" style="background-image: url('/Frontend/images/bg_2.jpg');" data-section="home" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-intro img" id="about-section" style="background-image: url(/Frontend/images/bg_1.jpg);">
			<div class="overlay"></div>
			<div class="container">
    ...
    <section class="ftco-section ftco-services-2 bg-light" id="workflow-section">
		...
		<section class="ftco-intro img" id="hotel-section" style="background-image: url(/Frontend/images/bg_4.jpg);">
			<div class="overlay"></div>
			<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <div class="carousel-agent owl-carousel">
            	<div class="item">
            		<div class="agent">
		    					<div class="img">
				    				<img src="/Frontend/images/team-1.jpg" class="img-fluid" alt="Colorlib Template">
				    				<div>
				    					<h3>I'm an agent</h3>
				    				</div>
			    				</div>
            	...
            	<div class="item">
            		<div class="agent">
		    					<div class="img">
				    				<img src="/Frontend/images/team-2.jpg" class="img-fluid" alt="Colorlib Template">
				    				<div>
				    					<h3>I'm an agent</h3>
				    				</div>
			    				</div>
            	...
            	<div class="item">
            		<div class="agent">
		    					<div class="img">
				    				<img src="/Frontend/images/team-3.jpg" class="img-fluid" alt="Colorlib Template">
				    				<div>
				    					<h3>I'm an agent</h3>
				    				</div>
			    				</div>
            	...
            	<div class="item">
            		<div class="agent">
		    					<div class="img">
				    				<img src="/Frontend/images/team-4.jpg" class="img-fluid" alt="Colorlib Template">
				    				<div>
				    					<h3>I'm an agent</h3>
				    				</div>
			    				</div>
